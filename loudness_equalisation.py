...
filename_core = 'uso_300ms_30_room-30-30-10'
folder_core = DIR / 'data' / 'distance_simulation' / '300ms' / filename_core
...
normalised_folder_path_all = DIR / 'data' / 'distance_simulation' / 'all'
...
def generate_normalised_files(folder_path, duration=5.0, LUFS=-25.0):
    file_paths = [f for f in abs_file_paths(folder_path)]
